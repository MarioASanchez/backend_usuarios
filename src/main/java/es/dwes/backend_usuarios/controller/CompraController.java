...
public class CompraController {
    ...
    @org.springframework.web.bind.annotation.GetMapping("/evento/{idEvento}")
    public ResponseEntity<List<String>> getAsientosOcupados(@org.springframework.web.bind.annotation.PathVariable Long idEvento) {
